...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'tabussey';//this will be your WCC username
      $dbUsr = 'tabussey';//this will be your WCC username
      $dbPass = 'ubfT2R5HYPHsVfY';//this will be the password found in the video.
